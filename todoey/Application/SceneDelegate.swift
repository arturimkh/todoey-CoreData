...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        setupWindows(with: navigationController, scene)
        setupNavigationBar(with: navigationController)
    ...
    func setupWindows(with navigationController: UINavigationController, _ scene: UIScene){
